                  ...
                  >
                    <div className="p-3 flex flex-col h-full items-center justify-center text-center">
                      <div className="mb-2 w-full">
                        <span className="text-base font-bold text-slate-200 bg-slate-900/60 px-3 py-1.5 rounded-md border border-slate-700/50 shadow-sm inline-flex items-center justify-center w-fit">
