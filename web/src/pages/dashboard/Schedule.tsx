                    ...
                    <div className="flex flex-col justify-center gap-3 min-w-[200px]">
                      ...
                      {cls.status !== 'ZAVRSEN' && (user?.role === 'SUPER_ADMIN' || user?.role === 'ADMIN' || user?.id === cls.profesorId?._id) && (
                        <Button 
                          ...
                          className="w-full flex items-center justify-center border-none bg-primary text-white hover:bg-primary/90 transition-colors"
                        >
                  ...
                  >
                    <div className="p-3 flex flex-col h-full items-center justify-center text-center">
                      <div className="mb-2 w-full">
                        <span className="text-base font-bold text-slate-200 bg-slate-900/60 px-2 rounded border border-slate-700/50 shadow-sm inline-flex items-center justify-center w-fit leading-none py-1">
                      ...
                      <div className="flex flex-col gap-1 w-full items-center">
                        {cls.students && cls.students.length > 0 ? (
                          cls.students.map((s: any) => (
                            <p key={s.studentId?._id} className="text-base font-medium text-slate-100 truncate w-full px-1">
                              {s.studentId?.firstName} {s.studentId?.lastName}
                            </p>
                          ))
                        ) : (
